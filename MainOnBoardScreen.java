...
public class MainOnBoardScreen extends AppCompatActivity {
    ...
    private int[] mImageResIds = new int[]{R.drawable.left, R.drawable.right,R.drawable.left};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_onboard_container);
        ...
        Log.e("MainOnBoardScreen",""+getPackageName());
    ...
    private String getVideoPath() {
        return "android.resource://" + "qapp.mangosoft.com.qapp" + "/" + R.raw.video;
    }
